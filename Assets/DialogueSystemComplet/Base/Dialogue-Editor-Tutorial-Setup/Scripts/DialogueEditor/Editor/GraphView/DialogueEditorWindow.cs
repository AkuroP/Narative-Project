...
namespace Team06
{
    ...
    public class DialogueEditorWindow : EditorWindow
    {
        ...
        public static bool ShowWindow(int instanceId, int line)
        {
            UnityEngine.Object
                item = EditorUtility
                    .InstanceIDToObject(instanceId); //Find Unity Object with this instanceID and load it in
            ...
            if (item is DialogueContainerSO) //Check if item is a DialogueContainerSO
            {
                ...
                DialogueEditorWindow
                    window =
                        GetWindow<DialogueEditorWindow>(); //Make a unity editor window of type DialogueEditorWindow
                window.titleContent = new GUIContent("Dialogue Editor"); //Name of editor window
                window._currentDialogueContainer =
                    item as DialogueContainerSO; // The DialogueContainerSo we will load in to the editor window
        ...
        private void GenerateToolBar()
        {
            ...
            {
                _toolbarMenu.menu.AppendAction(language.ToString(),
