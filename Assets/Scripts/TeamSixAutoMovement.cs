...
public class TeamSixAutoMovement : MonoBehaviour
{
    ...
    public struct MovingSettings
    {
        ...
        [Tooltip("x > 0 = Right | x < 0 = Left")]public Vector2 movingDir;
        [Tooltip("Le perso s'arrête en cinématique ?")]public bool pauseMoving;
    ...
    private void AutoMove()
    {
        ...
        {
            teamSixPlayer.PlayerController.Move(movingSettings[currentIndex].movingDir * movingSettings[currentIndex].movingSpeed * Time.deltaTime);
